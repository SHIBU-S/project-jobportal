                ...
                <Container className="mt-5">
                    <Row className="pt-5">
                        <Col className="text-center">
                            <span className="jobcategory-title" style={{backgroundColor:"#2042e3",padding:"5px 18px",color:"#fff"}}>Job Category</span>
                            <h2 className="jobcategory-titlename mt-3 p-3" style={{fontSize:"35px",fontWeight:"700",position:"relative"}}>Choose Your Desire Category</h2>
                            <p className="lightcolorline">There are many variations of passages of Lorem Ipsum available, but the majority have suffered <br /> alteration in some form.</p>
                        </Col>
                    </Row>
                </Container>
                ...
                <Container className="mt-5 p-5 mb-3" style={{height:"auto",backgroundColor:"white",boxShadow:"0 1rem 3rem rgba(35, 38, 45, 0.15)",borderRadius:"5px"}}>
                    <Row className="text-center">
                        ...
                        <Col sm={12} md={6} lg={3}  className=" p-2">
                            ...
                            <div className=" jobcategory-lists p-3" style={{border:"1px dashed #eee"}}>
                                <div className="mt-3 p-2 mx-auto mb-3 d-flex" style={{width:"20%",backgroundColor:"#2042e31c",borderRadius:"4px"}}>    
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="blue" class="bi bi-stack" viewBox="0 0 16 16">
                        ...
                        <Col sm={12} md={6} lg={3}  className=" p-2">
                            ...
                            <div className=" jobcategory-lists p-3" style={{border:"1px dashed #eee"}}>
                                <div className="mt-3 p-2 mx-auto mb-3 d-flex" style={{width:"20%",backgroundColor:"#2042e31c",borderRadius:"4px"}}>    
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="blue" class="bi bi-house-door" viewBox="0 0 16 16">
                        ...
                        <Col sm={12} md={6} lg={3}  className="p-2">
                            ...
                            <div className=" jobcategory-lists p-3" style={{border:"1px dashed #eee"}}>
                                <div className="mt-3 p-2 mx-auto mb-3 d-flex" style={{width:"20%",backgroundColor:"#2042e31c",borderRadius:"4px"}}>    
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="blue" class="bi bi-search" viewBox="0 0 16 16">
                    ...
                    <Row className="text-center mt-3">
                        <Col sm={12} md={6} lg={3}  className=" p-2">
                            ...
                            <div className=" jobcategory-lists p-3" style={{border:"1px dashed #eee"}}>
                                <div className="mt-3 p-2 mx-auto mb-3 d-flex" style={{width:"20%",backgroundColor:"#2042e31c",borderRadius:"4px"}}>    
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="blue" class="bi bi-currency-dollar" viewBox="0 0 16 16"><path d="M4 10.781c.148 1.667 1.513 2.85 3.591 3.003V15h1.043v-1.216c2.27-.179 3.678-1.438 3.678-3.3 0-1.59-.947-2.51-2.956-3.028l-.722-.187V3.467c1.122.11 1.879.714 2.07 1.616h1.47c-.166-1.6-1.54-2.748-3.54-2.875V1H7.591v1.233c-1.939.23-3.27 1.472-3.27 3.156 0 1.454.966 2.483 2.661 2.917l.61.162v4.031c-1.149-.17-1.94-.8-2.131-1.718zm3.391-3.836c-1.043-.263-1.6-.825-1.6-1.616 0-.944.704-1.641 1.8-1.828v3.495l-.2-.05zm1.591 1.872c1.287.323 1.852.859 1.852 1.769 0 1.097-.826 1.828-2.2 1.939V8.73z"/>
                                    </svg>
                                </div>
                        ...
                        <Col sm={12} md={6} lg={3}  className=" p-2">
                            ...
                            <div className=" jobcategory-lists p-3" style={{border:"1px dashed #eee"}}>
                                <div className="mt-3 p-2 mx-auto mb-3 d-flex" style={{width:"20%",backgroundColor:"#2042e31c",borderRadius:"4px"}}>    
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="blue" class="bi bi-rocket-takeoff" viewBox="0 0 16 16">
