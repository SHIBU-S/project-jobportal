...
//                 <Row className="jobbox" style={{ padding: '30px', animationDelay: '0.3s' }}>
//                 <Col md={2} className="d-flex align-items-center">
//                   <img src={SoftwareEngineerImg} className="img-fluid" alt="..." />
//                 </Col>
//                 <Col md={10} className="position-relative">
//                   <div className="jobcontent">
//                     <h4 className="BrowseRecentJobname mt-4 mt-md-0">
//                       <Link to="">Software <br className="d-none d-lg-block d-xxl-none" /> Engineer</Link>
//                     </h4>
//                     <p className="lightcolorline">
//                       We are looking for Enrollment Advisors who are looking to take 30-35 appointments per week. All leads are pre-scheduled.
//                     </p>
//                     <ul className="ps-0 jobcontent-lists">
//                       <li className="me-2r">
//                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" className="bi bi-reception-0" viewBox="0 0 16 16">
...
//                       </li>
//                       <li className="me-2">
//                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" className="bi bi-currency-dollar mb-1 me-1" viewBox="0 0 16 16">
//                           <path d="M4 10.781c.148 1.667 1.513 2.85 3.591 3.003V15h1.043v-1.216c2.27-.179 3.678-1.438 3.678-3.3 0-1.59-.947-2.51-2.956-3.028l-.722-.187V3.467c1.122.11 1.879.714 2.07 1.616h1.47c-.166-1.6-1.54-2.748-3.54-2.875V1H7.591v1.233c-1.939.23-3.27 1.472-3.27 3.156 0 1.454.966 2.483 2.661 2.917l.61.162v4.031c-1.149-.17-1.94-.8-2.131-1.718zm3.391-3.836c-1.043-.263-1.6-.825-1.6-1.616 0-.944.704-1.641 1.8-1.828v3.495l-.2-.05zm1.591 1.872c1.287.323 1.852.859 1.852 1.769 0 1.097-.826 1.828-2.2 1.939V8.73z"/>
//                         </svg>
//                         $20k - $25k
//                       </li>
//                       <li>
//                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" className="bi bi-geo-alt mb-1 me-1" viewBox="0 0 16 16">
    ...
    return(
        <>
            <Container fluid style={{backgroundColor:"#f6f9fc"}} className="pb-lg-5 border">
                ...
                {activePage === 1 && (
                <>
                <Container className="mt-5 mb-5 border">
                    <Row>
