    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton className='px-5 mt-3 '>
          <Modal.Title ><h3>Login From Here</h3></Modal.Title> 
         </Modal.Header>
        <Modal.Body>
          <Container>
            <Row className='px-4'>
              <Col><p className='lightcolorline'>Log in to continue your account <br />
         ...
         {/* <Row className='text-start border d-flex align-items-center p-2 bg-primary ms-4 me-4'>
    <Col  md={3} >
        <a href="your-linkedin-auth-url" aria-label="Login with LinkedIn" className='d-flex align-items-center'>
    ...
    <Col md={9} >
        <p className='mb-0 text-white'>Login In With LinkedIn</p>
          ...
          <Form className='px-4'>
            ...
            <Row>
                <Col><input type="checkbox"/> <span className='lightcolorline'>Remember Password</span></Col>
