          ...
          <Button variant="close" onClick={handleClose} className='position-absolute top-0 end-0 m-2 border p-2 closebutton' />
            ...
            <Row className='text-center  d-flex  p-2 linkedin ms-2 mt-2 me-2 ms-md-4 me-md-4 rounded-2'>
              <Col sm={12} className=' d-flex align-items-center '>
                ...
                <div className=' ms-5 ps-2 ps-md-4'><p className='mb-0 text-white p-1'>Login From LinkedIn</p></div>
              </Col>
            </Row>
            ...
            <Row className='text-center  d-flex  p-2 google ms-2 mt-2 me-2 ms-md-4 me-md-4 rounded-2'>
              <Col sm={12} className=' d-flex align-items-center'>
                ...
                <div className=' ms-5 ps-2 ps-md-4'><p className='mb-0 text-white p-1'>Login From Google</p></div>
              </Col>
            </Row>
            ...
            <Row className='text-center  d-flex  p-2 facebook ms-2 mt-2 me-2 ms-md-4 me-md-4 rounded-2'>
              <Col sm={12} className=' d-flex align-items-center'>
                ...
                <div className=' ms-5  ps-md-4'><p className='mb-0 text-white p-1'>Login From Facebook</p></div>
              </Col>
            </Row>
            ...
            <Form className='px-2 px-md-4'>
              ...
              <div className="mb-3">
                ...
                <input type="password" class="form-control px-4 py-2" id="exampleFormControlConfirmPassword1" placeholder="Enter password" />
              </div>
