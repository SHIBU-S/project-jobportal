...
//                                             <Form.Control type="number" className="p-0" placeholder="Salary" />
//                                         </FloatingLabel>
//                                     </Col>
//                                 </Row>
...
//                                             <Form.Control type="text" className="p-0" placeholder="Location" />
//                                         </FloatingLabel>
//                                     </Col>
//                                 </Row>
...
function AddCategory({ setActiveTab }) {
    ...
    function displayCategorydetails() {
        if (!Categoryname || !descriptionname || !Salary || !Locationname) {
                ...
                <Row>
                    <Col>
                        <div className="border mt-3">
                            ...
                            <div className="bg-white px-2">
                                <Row className="adminpanelformpage">
                                    <Col sm={2} className="d-flex align-items-center"><span className="ms-auto d-flex"><RiStarSFill fill="red" /> Category Name :</span></Col>
                                    <Col className="px-4">
                                        <FloatingLabel controlId="floatingInput" label="Category Name" className="mb-3 mt-3">
