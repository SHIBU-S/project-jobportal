                            ...
                            <Carousel>
                                <Carousel.Item style={{height:"auto"}}>
                                    <Carousel.Caption className="text-start ">
                                        ...
                                        <Row>
                                            <Col sm={2}><div style={{backgroundColor:"#ffffff21"}} className="rounded-circle p-1"><img src={Testlogo1} class="img-fluid rounded-circle" alt="..." /></div></Col>
                                            <Col>
                                                <div>
                                                    <h4 className="mt-4 mb-0" style={{fontSize:"17px"}}>Musharof Chowdhury</h4>
                                ...
                                <Carousel.Item style={{height:"auto"}}>
                                    <Carousel.Caption className="text-start">
                                        ...
                                        <p>" I just brought it and i love it. Lorem Ipsum is simply dummy text of the and typesetting industry. Lorem Ipsum has been the industry's standard dummy textever since the 1500s." </p>
                                        <Row>
                                            <Col sm={2}><div style={{backgroundColor:"#ffffff21"}} className="rounded-circle p-1"><img src={Testlogo2} class="img-fluid rounded-circle" alt="..." /></div></Col>
                                            <Col>
                                                <div>
                                ...
                                <Carousel.Item style={{height:"auto"}}>
                                    <Carousel.Caption className="text-start">
                                        ...
                                        <p>" I just brought it and i love it. Lorem Ipsum is simply dummy text of the and typesetting industry. Lorem Ipsum has been the industry's standard dummy textever since the 1500s." </p>
                                        <Row>
                                            <Col sm={2}><div style={{backgroundColor:"#ffffff21"}} className="rounded-circle p-1"><img src={Testlogo3} class="img-fluid rounded-circle" alt="..." /></div></Col>
                                            <Col>
                                                <div>
                                ...
                                <Carousel.Item style={{height:"auto"}}>
                                    <Carousel.Caption className="text-start">
                                        ...
                                        <p>" I just brought it and i love it. Lorem Ipsum is simply dummy text of the and typesetting industry. Lorem Ipsum has been the industry's standard dummy textever since the 1500s." </p>
                                        <Row>
                                            <Col sm={2}><div style={{backgroundColor:"#ffffff21"}} className="rounded-circle p-1"><img src={Testlogo4} class="img-fluid rounded-circle" alt="..." /></div></Col>
                                            <Col>
                                                <div>
                                                    <h4 className="mt-4 mb-0" style={{fontSize:"17px"}}>Karmo kerin</h4>
                                                    <span style={{fontSize:"13px",color:"#888"}}>CEO - Tredex</span>
