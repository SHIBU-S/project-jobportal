                        ...
                        <Col sm={12} md={10} lg={7} className="aboutUs2-animation pt-5 pt-lg-0 pt-xxl-5 ps-0 ps-lg-5">
                            ...
                            <Row className="ps-lg-5">
                                ...
                                <Col xs={11} sm={11} className=" ps-5 ps-lg-5 ps-xxl-4">
                                    <h5 className="ps-2">#1 Jobs site in UK</h5>
                                    <p className="ps-2 lightcolorline">Leverage agile frameworks to provide a robust synopsis for high <br className="d-none d-xxl-block"/> level overviews. Iterative</p>
                                </Col>
                            </Row>
                            ...
                            <Row className="ps-lg-5 mt-4">
                                ...
                                <Col xs={11} sm={11} className=" ps-5 ps-lg-5 ps-xxl-4">
                                    <h5 className="ps-2">Seamless searching</h5>
                                    <p className="ps-2 lightcolorline">Capitalize on low hanging fruit to identify a ballpark value added <br className="d-none d-xxl-block"/> activity to beta test.</p>
                                </Col>
                            </Row>
                            ...
                            <Row className="ps-lg-5 mt-4">
                                ...
                                <Col xs={11} sm={11} className=" ps-5 ps-lg-5 ps-xxl-4">
                                    <h5 className="ps-2">Hired in top companies</h5>
                                    <p className="ps-2 lightcolorline">Podcasting operational change management inside of workflows to <br className="d-none d-xxl-block"/> establish.</p>
                                </Col>
                            </Row>
                        </Col>
                    </Row> 
